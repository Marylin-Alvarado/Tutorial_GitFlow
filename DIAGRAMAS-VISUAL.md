...
│              │ (trabajo aislado) │ 🗑️ Se borra al merge  │
│              │                   │ 📍 Una por funcionalidad
├──────────────┼───────────────────┼─────────────────────────┤
│ RELEASE/*    │ 📦 LANZAMIENTO    │ ⏰ TEMPORAL (días)     │
│              │ (preparación)     │ 🗑️ Se borra al merge  │
│              │                   │ 📍 Antes de producción │
├──────────────┼───────────────────┼─────────────────────────┤
│ HOTFIX/*     │ 🚨 BUG CRÍTICO    │ ⏰ TEMPORAL (horas)    │
│              │ (respuesta rápida)│ 🗑️ Se borra al merge  │
│              │                   │ 📍 Desde MAIN          │
└──────────────┴───────────────────┴─────────────────────────┘
```
...
2️⃣ DEVELOP ES LA BASE
   develop ────●──●──●──●──●──●
                (integra features)
                (siempre funcional)

3️⃣ FEATURES SE AÍSLAN
   develop ──────┬──────┬──────┬──────
                 │      │      │
           feature/   feature/ feature/
           login    dashboard profile
...
4️⃣ RELEASES SON FORMALES
   develop → release → main + tag
   (preparación controlada)

5️⃣ HOTFIX ES EMERGENCIA
...
- 🖼️ Captura pantalla de los diagramas
